class FindAnswer:
    ...
    def search(self, intent_name, ner_tags, weather_tags):
        # 의도명, 개체명으로 답변 검색
        sql = self._make_query(intent_name, ner_tags, weather_tags)
    ...
    def _make_query(self, intent_name, ner_tags, weather_tags):
        sql = "select * from mango_train_data"
        if intent_name != None and ner_tags == None and weather_tags == None:
        ...
        if intent_name != None and weather_tags != None:
            where = ' where intent="%s" ' % intent_name
